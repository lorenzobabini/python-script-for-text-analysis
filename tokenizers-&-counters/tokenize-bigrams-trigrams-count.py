...
import csv
w = csv.writer(open(("C:/Users/LORENZO.BABINI/OneDrive - Università Cattolica del Sacro Cuore/Documenti/Digital Humanities/Python-environment/output/"+"bigrams_count_"+file_name+".csv"), "w"))
...
w = csv.writer(open(("C:/Users/LORENZO.BABINI/OneDrive - Università Cattolica del Sacro Cuore/Documenti/Digital Humanities/Python-environment/output/"+"trigrams_count_"+file_name+".csv"), "w"))
